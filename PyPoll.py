...
# Add our depenencies
# Add votes tothat candidate's count
import csv
import os
...
with open(file_to_load) as election_data:
    ...
    # Iterating through the candidate's list
    for candidate_name in candidate_votes:
       ...
       # To do: print out each candidate's name, vote count, and percentage of vote to the terminal
        ...
        if (vote > winning_count) and (vote_percentage > winning_percentage):
            # If true then set the winning_count = vote and winning percentage = vote_percentage
            winning_count = vote
